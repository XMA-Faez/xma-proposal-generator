...
const SummarySection: React.FC<SummarySectionProps> = ({
  ...
  const monthlyTotal = proposalData.selectedServices.reduce((total, service) => {
  ...
  return (
    <div className="mb-8 bg-gradient-to-br from-zinc-800 to-zinc-900 rounded-lg p-6 shadow-lg border border-zinc-700">
      ...
      <div className="space-y-3 mb-6">
        {/* Package */}
        {proposalData.includePackage && proposalData.selectedPackageIndex !== null && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 pb-3 border-b border-zinc-700">
            <div className="col-span-10">
              <div className="flex items-center">
                <span className="font-medium">{packages[proposalData.selectedPackageIndex].name} Package</span>
        ...
        {proposalData.selectedServices.length > 0 && (
          <>
            ...
            {proposalData.selectedServices.map((service) => {
              ...
              const discountedService = priceDetails.servicesWithDiscounts.find(s => s.id === service.id);
